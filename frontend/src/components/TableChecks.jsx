...
function TableChecks({ searchObj, objs, onSelectionChange }) {
    ...
    return (
        <div className="w-100 border border-secondary p-2">
            <input className="form-control form-control-sm" placeholder={searchObj} />
            <div style={{ height: '150px', overflowY: 'scroll', display: 'block' }}>
